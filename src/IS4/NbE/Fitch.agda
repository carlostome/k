...
R-preorder : IsPreorder _≡_ _R_
R-preorder = record { isEquivalence = P.isEquivalence ; reflexive = λ { P.refl → R-refl } ; trans = R-trans }
...
open import IS4.Semantics.PossibleWorlds.Interpretation.Fitch W _R_ R-preorder _≤_ ≤-preorder cod-R-monotone dom-R-monotone
import IS4.Norm as Norm
open Norm.Ne
open Norm.Nf
open Obj
open Hom
